    ...
    <Container>
      <section className="flex flex-col items-center justify-center py-10">
        ...
        <div className="mt-3 flex flex-col items-center justify-center gap-5 md:flex-row">
          <div className="flex min-w-[325px] max-w-[325px] flex-col items-center justify-center rounded-xl border-[3px] border-solid border-black bg-black py-5 text-white transition-all duration-300 hover:border-white hover:shadow-white_color">
            <NumberTickerClient />
