...
export function Contato() {
  return (
    <section className="py-10">
      <div className="relative flex h-[400px] w-full flex-col items-center justify-center overflow-hidden bg-black md:mx-auto md:h-[300px] md:w-[650px] md:rounded-xl md:shadow-xl lg:w-[940px]">
        <Meteors number={30} />
